    ...
    Private Sub SigPlusNET1_PenUp(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SigPlusNET1.PenUp
        ...
        If SigPlusNET1.KeyPadQueryHotSpot(3) > 0 Then 'if the OK hotspot is tapped, then...
            ...
            Try
                ...
                myimage.Save(direccionFirmas & "\firma.bmp", System.Drawing.Imaging.ImageFormat.Bmp)
                'myimage.Save("C:\Users\usuario\Desktop\Proyecto\ProyectoFinalOficial\Firmas\firma.bmp", System.Drawing.Imaging.ImageFormat.Bmp)
            Catch ex As Exception
                myimage = SigPlusNET1.GetSigImage()
                myimage.Save(direccionFirmas & "\firma1.bmp", System.Drawing.Imaging.ImageFormat.Bmp)
                'myimage.Save("C:\Users\usuario\Desktop\Proyecto\ProyectoFinalOficial\Firmas\firma1.bmp", System.Drawing.Imaging.ImageFormat.Bmp)
            End Try
